...
import { fetchCadastrosMotoristaAuditoria } from "@/lib/api/cadastros-motoristas-client";
      ...
      <div>
        ...
        <div className="mt-2 flex flex-wrap items-center justify-between gap-3">
          ...
          <Button variant="outline" size="sm" asChild>
            <Link href={`/cadastros/pessoas/motoristas/${params.id}`}>Ver cadastro</Link>
          </Button>
        </div>
      </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between gap-3">
                    <p className="text-sm font-medium">
                      {entry.action === "CREATE" && "Motorista cadastrado"}
                      {entry.action === "UPDATE" && "Dados atualizados"}
                      {entry.action === "DELETE" && "Motorista inativado"}
